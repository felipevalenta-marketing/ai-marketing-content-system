...
class ReportBuilder:
    ...
    def _build_common_metadata(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "video_type": payload.get("video_type") or metadata.get("video_type", ""),
    ...
    def _build_asset_summary(self, metrics: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "reel_script_count": metrics.get("reel_script_count", 0),
            ...
            "video_type": metrics.get("video_type", ""),
            "duration": metrics.get("duration", ""),
            "scene_count": metrics.get("scene_count", 0),
            "storyboard_scene_count": metrics.get("storyboard_scene_count", 0),
            "voiceover_length": metrics.get("voiceover_length", 0),
            "hook_present": metrics.get("hook_present", False),
            "cta_present": metrics.get("cta_present", False),
            "validation_status": metrics.get("validation_status", False),
            "pacing_score": metrics.get("pacing_score", 0.0),
            "factual_safety_score": metrics.get("factual_safety_score", 0.0),
            "video_realism_score": metrics.get("video_realism_score", 0.0),
            "video_brand_fit_score": metrics.get("video_brand_fit_score", 0.0),
            "video_platform_fit_score": metrics.get("video_platform_fit_score", 0.0),
            "video_validation_status": metrics.get("video_validation_status", False),
