...
CONTRACTS: dict[str, OutputContractSpec] = {
    ...
    "property_description": OutputContractSpec(
        ...
        required_fields=("title", "description", "highlights", "cta"),
        optional_fields=("notes",),
        field_types={
            "title": ("str",),
            "description": ("str",),
    ...
    "image_prompt": OutputContractSpec(
        ...
        required_fields=("image_prompt", "style", "camera", "lighting", "negative_prompt"),
        optional_fields=("notes",),
        field_types={
            "image_prompt": ("str",),
            "style": ("str",),
    ...
    "video_script": OutputContractSpec(
        ...
        required_fields=("hook", "scene_1", "scene_2", "scene_3", "voiceover", "cta"),
        optional_fields=("notes", "raw_content", "script", "scene_sequence", "storyboard", "camera_direction", "music_mood"),
        field_types={
            "hook": ("str",),
            "scene_1": ("str",),
            "scene_2": ("str",),
