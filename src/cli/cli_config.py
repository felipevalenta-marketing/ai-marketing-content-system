...
def build_feature_flags() -> dict[str, Any]:
    ...
    return {
        ...
        "enable_persistence": pipeline_config.enable_persistence,
        "persist_generations": pipeline_config.persist_generations,
        "persist_reports": pipeline_config.persist_reports,
        "persist_tracking": pipeline_config.persist_tracking,
        "persist_markdown": pipeline_config.persist_markdown,
        "storage_overwrite": pipeline_config.storage_overwrite,
        "enable_token_tracking": pipeline_config.enable_token_tracking,
        ...
        "enable_multi_brand_management": pipeline_config.enable_multi_brand_management,
        "enable_workflow_orchestration": pipeline_config.enable_workflow_orchestration,
        "default_workflow_type": pipeline_config.default_workflow_type,
        "workflow_persistence_enabled": pipeline_config.workflow_persistence_enabled,
        "workflow_stop_on_critical_failure": pipeline_config.workflow_stop_on_critical_failure,
        "workflow_continue_on_warnings": pipeline_config.workflow_continue_on_warnings,
        ...
        "enable_markdown_reports": pipeline_config.enable_markdown_reports,
        "enable_markdown_report_export": pipeline_config.enable_markdown_report_export,
        "default_markdown_report_type": pipeline_config.default_markdown_report_type,
    }
...
def build_safe_config_summary() -> dict[str, Any]:
    ...
    return {
        ...
        "enable_markdown_report_export": pipeline_config.enable_markdown_report_export,
        "default_markdown_report_type": pipeline_config.default_markdown_report_type,
        "markdown_report_output_root": pipeline_config.markdown_report_output_root,
        "enable_api_layer": pipeline_config.enable_api_layer,
        "enable_frontend_demo": pipeline_config.enable_frontend_demo,
        "api_debug": pipeline_config.api_debug,
        "enable_authentication": pipeline_config.enable_authentication,
        "enable_rbac": pipeline_config.enable_rbac,
        "default_user_role": pipeline_config.default_user_role,
        "first_user_admin": pipeline_config.first_user_admin,
        "jwt_expiration_hours": pipeline_config.jwt_expiration_hours,
        "user_storage_path": pipeline_config.user_storage_path,
        "enable_analytics": pipeline_config.enable_analytics,
        "analytics_default_type": pipeline_config.analytics_default_type,
        "analytics_include_storage": pipeline_config.analytics_include_storage,
        "analytics_include_tokens": pipeline_config.analytics_include_tokens,
        "analytics_include_costs": pipeline_config.analytics_include_costs,
        "analytics_include_governance": pipeline_config.analytics_include_governance,
        "storage_root": pipeline_config.storage_root,
