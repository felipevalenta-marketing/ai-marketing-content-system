...
ASSET_CONTRACTS: dict[str, AssetContract] = {
    ...
    "reel_script": AssetContract(
        ...
        defaults={"hook": "", "script": "", "scenes": [], "voiceover_direction": "", "cta": "", "visual_direction": "", "notes": "", "raw_content": ""},
        aliases={"scene": "scenes", "description": "script", "summary": "script", "call_to_action": "cta", "raw": "raw_content"},
    ),
    ...
    "video_prompt": AssetContract(
        ...
        defaults={"scene_description": "", "camera_motion": "", "sequence": [], "mood": "", "duration": "", "voiceover_direction": "", "platform_use": "", "notes": "", "raw_content": ""},
        aliases={"scene": "scene_description", "motion": "camera_motion", "raw": "raw_content"},
    ),
