...
PERMISSION_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "organization:read": {"permission": "organization:read", "domain": "organization", "label": "Read organizations", "description": ""},
    "organization:create": {"permission": "organization:create", "domain": "organization", "label": "Create organizations", "description": ""},
    "organization:update": {"permission": "organization:update", "domain": "organization", "label": "Update organizations", "description": ""},
    "organization:delete": {"permission": "organization:delete", "domain": "organization", "label": "Delete organizations", "description": ""},
    "organization:manage_members": {"permission": "organization:manage_members", "domain": "organization", "label": "Manage organization members", "description": ""},
    "team:read": {"permission": "team:read", "domain": "team", "label": "Read teams", "description": ""},
    "team:create": {"permission": "team:create", "domain": "team", "label": "Create teams", "description": ""},
    "team:update": {"permission": "team:update", "domain": "team", "label": "Update teams", "description": ""},
    "team:delete": {"permission": "team:delete", "domain": "team", "label": "Delete teams", "description": ""},
    "brand_access:read": {"permission": "brand_access:read", "domain": "brand_access", "label": "Read brand access", "description": ""},
    "brand_access:manage": {"permission": "brand_access:manage", "domain": "brand_access", "label": "Manage brand access", "description": ""},
...
PERMISSION_DOMAINS: dict[str, dict[str, Any]] = {
    ...
    "organization": {"domain": "organization", "label": "Organizations", "description": "Organization management and membership access."},
    "team": {"domain": "team", "label": "Teams", "description": "Team management access."},
    "brand_access": {"domain": "brand_access", "label": "Brand Access", "description": "Organization-brand access relationships."},
